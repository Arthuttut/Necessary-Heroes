ItemEvents.rightClicked(event => {
    ...
    const isPrototypeMain = mainHand.getId() === 'ben10:recalibrated';
    const isPrototypeOff = offHand.getId() === 'ben10:recalibrated';
    ...
    if (isPrototypeMain || isPrototypeOff) {
        if (
            ...
            player.runCommandSilent('superpower add ben10:recalibrated/recalibrated @p');
            ...
            player.runCommandSilent('playsound ben10:recalibrated.prime player @p');
